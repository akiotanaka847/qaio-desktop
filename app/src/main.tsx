...
import { TooltipProvider } from "@qaio-ai/core";
...
// ~/.qaio/logs/frontend.log (or ~/.dev-qaio/logs/frontend.log in dev).
initFrontendLogging();
 ...
 * `qaio-engine-ready` (or the injection raced in early). Hooks deep in
