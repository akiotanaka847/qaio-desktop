/**
 * `.qaio/activity/activity.json` — the board.
 *
 * Schema-validated via `@qaio-ai/agent-schemas/activity.schema.json`.
 * Written atomically on every mutation (the backend handles the temp-file + rename).
 */

import schema from "@qaio-ai/agent-schemas/activity.schema.json";
