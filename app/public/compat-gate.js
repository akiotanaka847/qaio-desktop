...
(function () {
  ...
  var MESSAGES = {
    en: {
      title: "Qaio needs a newer version of macOS",
      body: "Please update your Mac to macOS Ventura (13) or later, then open Qaio again.",
    },
    es: {
      title: "Qaio necesita una versión más reciente de macOS",
      body: "Actualiza tu Mac a macOS Ventura (13) o una versión posterior y vuelve a abrir Qaio.",
    },
    pt: {
      title: "O Qaio precisa de uma versão mais recente do macOS",
      body: "Atualize seu Mac para o macOS Ventura (13) ou mais recente e abra o Qaio novamente.",
    },
  };
