//! Qaio product prompts, the authoritative identity copy for the Qaio
//! desktop app.
//!
...
//! Qaio desktop agent behaves and speaks.
...
pub use base::QAIO_SYSTEM_PROMPT;
...
mod tests {
    ...
    fn system_prompt_contains_new_interaction_gates() {
        ...
        assert!(prompt.contains("# Qaio Context"));
