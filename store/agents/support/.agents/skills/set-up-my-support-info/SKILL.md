...
6. **Write atomically.** Write to `context/support-context.md.tmp`, rename to `context/support-context.md`. Single file under `context/`  -  NOT under `.agents/` or `.qaio/` (watcher skips).
