...
7. **Write atomically.** Write to `legal-context.md.tmp`, rename to `legal-context.md`. Single file at agent root. NOT under subfolder. NOT under `.agents/`. NOT under `.qaio/<agent>/`.
