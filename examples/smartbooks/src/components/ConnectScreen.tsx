    ...
    <div className="screen screen--center">
      <div className="connect-card">
        ...
        <p className="muted">
          ...
          {" Built on "}
          <a href="https://getqaio.ai" target="_blank" rel="noreferrer">
            Qaio Engine
          </a>
          .
        </p>
        ...
        >
          ...
          <label className="field">
            ...
            <input
              ...
              placeholder="from ~/.qaio/engine.json or your .env"
              autoComplete="off"
              spellCheck={false}
              required
            />
        ...
        <details className="help">
          ...
          <p>
            ...
            <code>QAIO_ENGINE_TOKEN=your-token cargo run -p qaio-engine-server --bin qaio-engine</code>{" "}
            — it prints the port on stdout and writes a manifest to{" "}
            <code>~/.qaio/engine.json</code>. Or point this at any remote
            deployment running the same binary (e.g. Qaio Always On).
          </p>
        </details>
      </div>
    </div>
