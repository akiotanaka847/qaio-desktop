...
import type { ChatPanelProps, FeedItem, ToolsAndCardsProps } from "@qaio-ai/chat"
import { SplitView } from "@qaio-ai/layout"
...
export interface AIBoardProps {
  ...
  /** Name shown next to the avatar in the panel header (e.g. "Qaio"). */
  ...
  renderTurnSummary?: import("@qaio-ai/chat").ChatPanelProps["renderTurnSummary"]
  /** Custom renderer for system messages. Forwarded to ChatPanel. */
  renderSystemMessage?: import("@qaio-ai/chat").ChatPanelProps["renderSystemMessage"]
  ...
  renderUserMessage?: import("@qaio-ai/chat").ChatPanelProps["renderUserMessage"]
  ...
  prepareAttachments?: import("@qaio-ai/chat").ChatPanelProps["prepareAttachments"]
  /** Emitted when `prepareAttachments` rejects any incoming files. */
  onAttachmentRejections?: import("@qaio-ai/chat").ChatPanelProps["onAttachmentRejections"]
  /** Called when the user clicks the open button on an inline link. Forwarded to ChatPanel. */
  onOpenLink?: import("@qaio-ai/chat").ChatPanelProps["onOpenLink"]
  /** Custom renderer for markdown links. Forwarded to ChatPanel. */
  renderLink?: import("@qaio-ai/chat").ChatPanelProps["renderLink"]
  /**
