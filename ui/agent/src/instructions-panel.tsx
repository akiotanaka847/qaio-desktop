 ...
 * Visual style matches Qaio's ContextTab exactly: labeled textareas
 * with auto-save on blur, bg-secondary, subtle borders.
 */
  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        ...
        className="w-full text-sm text-foreground leading-relaxed bg-secondary outline-none rounded-xl px-4 py-3 border border-black/[0.04] hover:border-black/[0.1] focus:border-black/[0.15] focus:bg-card transition-all duration-200 resize-none placeholder:text-muted-foreground/30"
      />
    </div>
  )
}
