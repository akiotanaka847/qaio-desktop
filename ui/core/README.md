...
Foundation layer for Qaio UI. 36 shadcn/ui components, design tokens, CSS animations, and utilities.

## Install

```bash
pnpm add @qaio-ai/core
```

## Usage

```tsx
import { Button, Badge, Card, Tooltip } from "@qaio-ai/core"
import "@qaio-ai/core/src/globals.css"
