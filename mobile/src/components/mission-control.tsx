...
import type { Agent, ConversationEntry } from "@qaio-ai/engine-client";
  ...
  return (
    <div className="flex min-h-full flex-col bg-background safe-top">
      <header className="flex items-center justify-between px-4 pt-5 pb-3">
        <div>
          <h1 className="text-xl font-semibold leading-tight">Qaio</h1>
        ...
        {!initializing && error && (
          <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
            ...
            <p className="mt-1 max-w-xs text-sm text-muted-foreground">
              Make sure Qaio is still open on your Mac, then tap retry.
            </p>
            <button
