...
/// helper so REST callers can submit `~/Documents/Qaio/...` paths verbatim.
///
...
pub struct EnginePaths {
    /// Qaio docs directory — holds workspaces (`~/Documents/Qaio`).
    pub docs_dir: PathBuf,
    /// Qaio home directory — holds `engine.json`, DB (`~/.qaio`).
