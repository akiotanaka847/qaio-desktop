...
//!
//! Relocated from `app/qaio-tauri/src/agent_store/{routines,routine_runs}.rs`
...
pub(crate) fn ensure_qaio_dir(root: &Path) -> CoreResult<()> {
    let dir = root.join(".qaio");
