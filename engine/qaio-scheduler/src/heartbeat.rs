...
use chrono::Timelike;
use qaio_events::{EventQueueHandle, QaioInput};
...
/// Runs a periodic heartbeat, pushing `QaioInput::heartbeat` into the queue.
...
impl HeartbeatRunner {
    ...
    async fn run(
        ...
        loop {
            ...
            let mut input = QaioInput::heartbeat(&config.prompt);
