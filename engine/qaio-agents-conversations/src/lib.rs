//! Orchestrates multi-session conversation lifecycle for Qaio agents.
//!
//! Sits ABOVE `qaio-terminal-manager` (raw CLI subprocess) and BELOW the Tauri
...
//!   disk persistence (`.qaio/sessions/{provider}/{key}.sid`).
