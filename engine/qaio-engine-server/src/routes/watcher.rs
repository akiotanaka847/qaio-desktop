...
//!
//! Starts a `qaio-file-watcher` instance over the agent directory; change
//! events flow into the engine's event sink as `QaioEvent` variants and
...
use qaio_file_watcher::start_watching;
