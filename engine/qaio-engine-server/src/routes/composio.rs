...
//!
//! Wraps the transport-neutral `qaio_composio::commands` API. Tauri
//! command wrappers in `app/qaio-tauri/src/composio_commands.rs` stay
...
use qaio_composio::apps::ComposioAppEntry;
use qaio_composio::cli::{ComposioStatus, StartLinkResponse, StartLoginResponse};
use qaio_composio::commands as inner;
use qaio_composio::connection_watcher;
