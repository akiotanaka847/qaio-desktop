//! `/v1/agents/*` REST routes — typed CRUD over `.qaio/<type>/<type>.json`.
//!
...
// — owned by `qaio_engine_core::conversations`. Not duplicated here.
