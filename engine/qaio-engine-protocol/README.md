# qaio-engine-protocol

Wire types for the Qaio Engine. One crate, two consumers:

1. `qaio-engine-server` — Rust side of the server.
2. `@qaio-ai/engine-client` — TypeScript side of every client.
