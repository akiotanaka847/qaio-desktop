...
| [files-first.md](files-first.md) | `.qaio/` layout, atomic writes, schemas, AI-native reactivity |
...
| [engine-server.md](engine-server.md) | `qaio-engine` binary — config, startup handshake, supervision, deployment |
