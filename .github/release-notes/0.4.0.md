...
- Data consolidates under `~/.qaio/` (workspaces move out of `~/Documents/Qaio/` automatically on first launch)
...
- Your workspaces will move from `~/Documents/Qaio/` to `~/.qaio/workspaces/` on first launch. The old location stays as a backup.
